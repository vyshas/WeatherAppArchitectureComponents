...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMainViewModelFactory = InjectorUtils.provideMainActivityViewModelFactory(this);

        mMainActivityViewModel = ViewModelProviders.of(this,mMainViewModelFactory).get(MainActivityViewModel.class);

        mMainActivityViewModel.getForecastsAfterDate(date).observe(this,weatherEntries -> {
