...
public class DetailActivity extends AppCompatActivity{
    ...
    private DetailViewModelFactory mDetailViewModelFactory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDetailViewModelFactory = InjectorUtils.provideDetailViewModelFactory(this,date);

        mViewModel = ViewModelProviders.of(this,mDetailViewModelFactory).get(DetailActivityViewModel.class);

        //observe liveData
        mViewModel.getWeather(date).observe(this,weatherEntry -> {if (weatherEntry!=null) bindWeatherToUI(weatherEntry);});
